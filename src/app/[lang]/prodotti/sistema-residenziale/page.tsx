...
/** Prodotti da mostrare in Sistema Residenziale */
const RESIDENZIALE_PRODUCT_IDS = [
  ...
  "ev-diamond",   // EV Charger · Forma a diamante
  "ev-oval",      // EV Charger · Forma ovale
  "ev-square",    // EV Charger · Forma quadrata
] as const;

const residenzialeSet = new Set(RESIDENZIALE_PRODUCT_IDS);
const residenzialeProducts = VISIBLE_PRODUCTS.filter((p) => residenzialeSet.has(p.id as typeof RESIDENZIALE_PRODUCT_IDS[number]));

export default function SistemaResidenzialePage() {
  ...
  return (
    <main className="page-content font-sans">
      <section className="relative -mt-[88px] pt-[88px]">
        <HeroBackground src="/image/heroes/prodotti_hero.jpg" alt="Sistema Residenziale" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12 text-white">
          ...
          <p className="mt-2 max-w-2xl text-sm text-white/85">
            Soluzioni fotovoltaiche complete per applicazioni residenziali.
          </p>
        </div>
      </section>
